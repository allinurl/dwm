...
static Key keys[] = {
  ...
  {0, 0x1008ff11, spawn, SHCMD ("amixer -c 0 set Master 1dB- unmute")},
  {0, 0x1008ff12, spawn, SHCMD ("amixer -c 0 set Master mute")},
  {0, 0x1008ff13, spawn, SHCMD ("amixer -c 0 set Master 1dB+ unmute")},
